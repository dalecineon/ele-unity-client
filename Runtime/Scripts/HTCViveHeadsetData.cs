...
public class HTCViveHeadsetData : MonoBehaviour
{
    ...
    void DummyDataProcessor(){
        ...
        _leftEye.IsGazeValid = true;
        _rightEye.IsGazeValid = true;

        //Generate random gaze positions and rotations for testing.
        Vector3 leftGazeVec = new Vector3(UnityEngine.Random.Range(-0.1f, 0.1f), UnityEngine.Random.Range(-0.1f, 0.1f), UnityEngine.Random.Range(0.5f, 1f));
        Vector3 rightGazeVec = new Vector3(UnityEngine.Random.Range(-0.1f, 0.1f), UnityEngine.Random.Range(-0.1f, 0.1f), UnityEngine.Random.Range(0.5f, 1f));

        leftGazeTransform.position = leftGazeVec;
        leftGazeTransform.rotation = Quaternion.Euler(UnityEngine.Random.Range(-10f, 10f), UnityEngine.Random.Range(-10f, 10f), 0);
        rightGazeTransform.position = rightGazeVec;
        rightGazeTransform.rotation = Quaternion.Euler(UnityEngine.Random.Range(-10f, 10f), UnityEngine.Random.Range(-10f, 10f), 0);
        ...
        Quaternion leftGazeQuaternion = Quaternion.Euler(UnityEngine.Random.Range(-10f, 10f), UnityEngine.Random.Range(-10f, 10f), 0);
        Quaternion rightGazeQuaternion = Quaternion.Euler(UnityEngine.Random.Range(-10f, 10f), UnityEngine.Random.Range(-10f, 10f), 0);

        Vector3 leftForward = leftGazeQuaternion * Vector3.forward;
        Vector3 rightForward = rightGazeQuaternion * Vector3.forward;

        _leftEye.GazeForward.SetPosition(leftForward);
        _rightEye.GazeForward.SetPosition(rightForward);

        //Generate random pupil diameter for testing.
        _leftEye.PupilDiameter = UnityEngine.Random.Range(2f, 8f);
        _rightEye.PupilDiameter = UnityEngine.Random.Range(2f, 8f);

        _leftEye.EyeOpenness = UnityEngine.Random.Range(0f, 1f);
        _rightEye.EyeOpenness = UnityEngine.Random.Range(0f, 1f);
